...
namespace Advance.WorkflowUtility
{
    ...
    public sealed class WFCheckNationalCode : CodeActivity
    {
        [RequiredArgument]
        [Input("National Code")]
        public InArgument<string> NationalCode { get; set; }
        [Output("IsValid")]
        public OutArgument<bool> IsValidNationalCode { get; set; }
        protected override void Execute(CodeActivityContext context)
        {
            ...
            #endregion
            string nationalCode = context.GetValue(this.NationalCode);
            if (nationalCode != null && nationalCode != "" && isValidNationalCode(nationalCode))
            {

                this.IsValidNationalCode.Set(context, true);
            }
            else
            {
                this.IsValidNationalCode.Set(context, false);
            }
        }
