...
namespace Advance.WorkflowUtility
{
    public class Common
    {
        ...
        public Common(IOrganizationService orgService)
        {
        ...
        public Guid CloneRecord(string entityName, string objectId, string fieldstoIgnore, string prefix)
        {
            ...
            Entity retrievedObject = orgService.Retrieve(entityName, new Guid(objectId), new ColumnSet(allColumns: true));
            tracingService.Trace("retrieved object OK");

            Entity newEntity = new Entity(entityName);
            string PrimaryIdAttribute = "";
            string PrimaryNameAttribute = "";
            List<string> atts = getEntityAttributesToClone(entityName, orgService, ref PrimaryIdAttribute, ref PrimaryNameAttribute);
            ...
            Guid createdGUID = orgService.Create(newEntity);
            ...
            {
                Entity record = orgService.Retrieve(entityName, createdGUID, new ColumnSet("statuscode", "statecode"));
                ...
                {
                    Entity setStatusEnt = new Entity(entityName);
                    setStatusEnt.Id = createdGUID;
                    ...
                    orgService.Update(setStatusEnt);
                }
            }
